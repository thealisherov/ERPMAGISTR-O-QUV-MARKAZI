      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex flex-col items-center mb-6">
            ...
            <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-semibold mt-2">
              {teacher.salaryType}
            </span>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <h3 className="text-sm font-semibold text-gray-700 mb-3">Maosh Ma'lumotlari</h3>
            <div className="space-y-2">
              {teacher.baseSalary > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Asosiy maosh:</span>
                  <span className="font-bold text-gray-900">{formatCurrency(teacher.baseSalary)}</span>
                </div>
              )}
              {teacher.paymentPercentage > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Foiz:</span>
                  <span className="font-bold text-gray-900">{teacher.paymentPercentage}%</span>
                </div>
              )}
            </div>
          </div>
                ...
                {groups.map((group) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <span className="font-bold text-blue-600">{formatCurrency(group.price)}</span>
                    </div>
                  </Link>
                ))}
              </div>
